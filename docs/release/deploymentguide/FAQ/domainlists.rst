...
To discover if additional domains should be added to the table, open the **Sessions | Session History** report and inspect the entries that were registered **immediately after** browsing to the specific domain.
