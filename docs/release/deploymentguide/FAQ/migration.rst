...
5.  Create a new Shield system. Form a new Shield Kubernetes cluster as described in `here <../installation.html>`_. 
...
8.  Continue with the deployment instructions. The deployment will refer to the updated custom-management file. Go `here <../installation.html#deploy-shield>`_.
